...
class ServiceLocator {
  void init(){
    ...
    /// Remote DataSource
    sl.registerLazySingleton<BaseFirebaseAuthRemoteDataSource>(() => FirebaseAuthRemoteService(sl()));
    sl.registerLazySingleton<BaseDatabaseRemoteDataSource>(() => DatabaseRemoteDatasource(sl()));
